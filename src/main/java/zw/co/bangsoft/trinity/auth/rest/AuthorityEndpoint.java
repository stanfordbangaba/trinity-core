...
public class AuthorityEndpoint {
	...
	public Response create(AccessRight entity) {
		...
		return Response.created(
				UriBuilder.fromResource(AuthorityEndpoint.class)
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<AccessRight> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT a FROM Authority a WHERE a.id = :entityId ORDER BY a.id",
						AccessRight.class);
	...
	@GET
	@Produces("application/json")
	public List<AccessRight> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		TypedQuery<AccessRight> findAllQuery = em.createQuery(
				"SELECT DISTINCT a FROM Authority a ORDER BY a.id",
				AccessRight.class);
