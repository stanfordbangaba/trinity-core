...
public class UserEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<User> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.userRoles WHERE u.id = :entityId ORDER BY u.id",
						User.class);
	...
	public List<User> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<User> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT u FROM User u LEFT JOIN FETCH u.userRoles ORDER BY u.id",
						User.class);
